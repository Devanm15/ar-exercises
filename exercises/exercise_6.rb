...
@store1.employees.create(first_name: "Jeff", last_name: "b", hourly_rate: 100)
@store1.employees.create(first_name: "David", last_name: "c", hourly_rate: 60)
@store1.employees.create(first_name: "Michelle", last_name: "d", hourly_rate: 70)
...
@store2.employees.create(first_name: "Cian", last_name: "g", hourly_rate: 80)